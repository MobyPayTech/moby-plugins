...
```json
{
  ...
  "token": "2419|apggQLOUdc81Bvi5b3fJjk2ocZl4mTjMgfKAvb3fa6e1112b",
  "expired_at": "2026-03-17T06:32:30.775097Z",
  "scope": "pay"
}
```
...
For a full reference to the API, please visit: [MobyPay API Reference](https://dev.pay.mobycheckout.com/api/documentation)
